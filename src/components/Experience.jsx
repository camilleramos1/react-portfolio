...
const Experience = () => {
  ...
  return (
    <div name='experience' className='w-full h-screen resume-skills'>
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full '>
            <div className=''>
                <p className='text-4xl font-bold p-2 inline experience-title'>Resume & Skills</p>
            </div>
            
            <a href="/resume.pdf" download className='px-2 py-2 exp-resume-btn w-1/4 mt-5'>Download Resume <LiaFileDownloadSolid size={20}/></a>
            <p className='py-6'>Some of the technologies I enjoy working with:</p>
